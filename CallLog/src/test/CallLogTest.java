...
import calllog.CallLogFactory;
import calllog.CallLogStatus;
import calllog.ICallLogFactory;
...
public class CallLogTest {
    ...
    public void setUp() throws Exception {
        calllog = ICallLogFactory.createCallLog(testline);
    }


    @Test
    public void test_calllog_creation () {
        assertTrue(ICallLogFactory.createCallLog(testline)!=null);
    }
